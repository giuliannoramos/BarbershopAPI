...
{
    /// <inheritdoc />
    public partial class MigratiosOrder : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "teste3", new DateTime(2023, 10, 11, 22, 8, 43, 791, DateTimeKind.Utc).AddTicks(7018), 10, new DateTime(2023, 10, 11, 22, 8, 43, 791, DateTimeKind.Utc).AddTicks(7019) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 10, 11, 22, 8, 43, 791, DateTimeKind.Utc).AddTicks(6827), 500, 1, 2 },
                    { 2, new DateTime(2023, 10, 11, 22, 8, 43, 791, DateTimeKind.Utc).AddTicks(6831), 501, 2, 2 }
                });

            migrationBuilder.InsertData(
                table: "Payment",
                columns: new[] { "PaymentId", "BuyDate", "CouponId", "Description", "GrossTotal", "NetTotal", "OrderId", "PaymentMethod", "Status" },
                values: new object[] { 1, new DateTime(2023, 10, 11, 22, 8, 43, 791, DateTimeKind.Utc).AddTicks(7003), null, "Para de ler isso aqui e vai programar", 80m, 60m, 1, "Dinheiro", 1 });
