    ...
    public partial class orderMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "teste3", new DateTime(2023, 10, 3, 18, 57, 58, 912, DateTimeKind.Utc).AddTicks(3351), 10, new DateTime(2023, 10, 3, 18, 57, 58, 912, DateTimeKind.Utc).AddTicks(3351) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 10, 3, 18, 57, 58, 912, DateTimeKind.Utc).AddTicks(3153), 500, 1, 2 },
                    { 2, new DateTime(2023, 10, 3, 18, 57, 58, 912, DateTimeKind.Utc).AddTicks(3180), 501, 2, 2 }
                });

            migrationBuilder.InsertData(
                table: "Payment",
                columns: new[] { "PaymentId", "BuyDate", "CouponId", "Description", "GrossTotal", "NetTotal", "OrderId", "PaymentMethod", "Status" },
                values: new object[] { 1, new DateTime(2023, 10, 3, 18, 57, 58, 912, DateTimeKind.Utc).AddTicks(3337), null, "Para de ler isso aqui e vai programar", 80m, 60m, 1, "Dinheiro", 1 });
