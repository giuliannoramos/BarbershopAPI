    ...
    public partial class orderInitMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "teste3", new DateTime(2023, 10, 1, 0, 4, 23, 319, DateTimeKind.Utc).AddTicks(1497), 10, new DateTime(2023, 10, 1, 0, 4, 23, 319, DateTimeKind.Utc).AddTicks(1498) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 10, 1, 0, 4, 23, 319, DateTimeKind.Utc).AddTicks(1327), 500, 1, 2 },
                    { 2, new DateTime(2023, 10, 1, 0, 4, 23, 319, DateTimeKind.Utc).AddTicks(1353), 501, 2, 2 }
                });

            migrationBuilder.InsertData(
                table: "Payment",
                columns: new[] { "PaymentId", "BuyDate", "CouponId", "Description", "GrossTotal", "NetTotal", "OrderId", "PaymentMethod", "Status" },
                values: new object[] { 1, new DateTime(2023, 10, 1, 0, 4, 23, 319, DateTimeKind.Utc).AddTicks(1483), null, "Para de ler isso aqui e vai programar", 80m, 60m, 1, "Dinheiro", 1 });
