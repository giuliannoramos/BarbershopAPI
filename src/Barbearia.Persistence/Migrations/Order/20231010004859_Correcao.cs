    ...
    public partial class Correcao : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "teste3", new DateTime(2023, 10, 10, 0, 48, 59, 774, DateTimeKind.Utc).AddTicks(1791), 10, new DateTime(2023, 10, 10, 0, 48, 59, 774, DateTimeKind.Utc).AddTicks(1806) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 10, 10, 0, 48, 59, 774, DateTimeKind.Utc).AddTicks(1491), 500, 1, 2 },
                    { 2, new DateTime(2023, 10, 10, 0, 48, 59, 774, DateTimeKind.Utc).AddTicks(1564), 501, 2, 2 }
                });

            migrationBuilder.InsertData(
                table: "Payment",
                columns: new[] { "PaymentId", "BuyDate", "CouponId", "Description", "GrossTotal", "NetTotal", "OrderId", "PaymentMethod", "Status" },
                values: new object[] { 1, new DateTime(2023, 10, 10, 0, 48, 59, 774, DateTimeKind.Utc).AddTicks(1758), null, "Para de ler isso aqui e vai programar", 80m, 60m, 1, "Dinheiro", 1 });
